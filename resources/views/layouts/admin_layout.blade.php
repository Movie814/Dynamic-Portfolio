...
<html lang="en">
    <head>
        ...
        <link href="{{secure_asset('css/adminstyles.css')}}" rel="stylesheet" />
    ...
    <body>
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{route('serviceCreate')}}">Create</a>
                                    <a class="nav-link" href="{{route('serviceCreate.list')}}">List</a>
                                </nav>
                            </div>
                            ...
                            <a class="nav-link" href="{{route('fontindex')}}">
        ...
        <script src="{{secure_asset('js/adminscripts.js')}}"></script>
    </body>
</html>

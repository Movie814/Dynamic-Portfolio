    ...
    <div class="container-fluid ">
        ...
        <div class="row">
            <div class="form-group col-md-4 mt-3">
                ...
                <img style="height: 30vh" src="{{(@$main->bc_img)?url($main->bc_img):asset("assets/img/bc_img)}}" alt="">
                <input type="file" class="mt-3 form-control" name="bc_img" id="bc_img" >
                
            </div>
            <div class="form-group col-md-3 mt-4"> 
               <div> <label for="title"> <h6> <b>Title</b> </h6> </label>
                <input type="text" class="form-control" name="title" id="title" value="{{$main->title}}" required>
            </div>
               <div>
                <label for="sub_title"><h6> <b>Sub Title</b> </h6></label>
                <input type="text" class="form-control" name="sub_title" id="sub_title" value="{{$main->sub_title}}" required>
               </div>
               <div>
